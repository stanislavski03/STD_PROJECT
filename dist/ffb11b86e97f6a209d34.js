document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById("application__form").addEventListener('submit', function (e) {
    e.preventDefault();
    var application__form__name = document.getElementById('application__form__name');
    var application__form__phone = document.getElementById('application__form__phone');
    var application__form__name_value = application__form__name.value.trim();
    var application__form__phone_value = application__form__phone.value.trim();

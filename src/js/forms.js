...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById("course_program__form").addEventListener('submit', function (e) {
        e.preventDefault();


        const course_program__form__name = document.getElementById('course_program__form__name');
        const course_program__form__phone = document.getElementById('course_program__form__phone');
        const course_program__form__name_value = course_program__form__name.value.trim();
        const course_program__form__phone_value = course_program__form__phone.value.trim();
    ...
    document.getElementById("application__form").addEventListener('submit', function (e) {
        e.preventDefault();
